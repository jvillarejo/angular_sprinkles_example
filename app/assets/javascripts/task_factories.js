...
sprinkles.service('tasks_incomplete', function (tasks_completed) {
  return function (todos) {
    return todos.length - tasks_completed(todos);
  };
});

sprinkles.service('mark_all_as_completed', function ($http) {
  return function (todos) {
...
sprinkles.service('clear_completed', function ($http) {
  return function (todos) {
    var completed = todos
